<?= card_open(isset($row) ? '<i class="icon cil-window"></i> Edit Prod_reject' : '<i class="icon cil-window"></i> Tambah Prod_reject') ?>
    <form method="post">
        <?= bs_floating_input('id', 'text', (isset($row) ? $row->id : '')); ?><?= bs_floating_input('prod_detail_id', 'text', (isset($row) ? $row->prod_detail_id : '')); ?><?= bs_floating_input('kd_reject', 'text', (isset($row) ? $row->kd_reject : '')); ?><?= bs_floating_input('qty', 'text', (isset($row) ? $row->qty : '')); ?><?= bs_floating_input('is_deleted', 'text', (isset($row) ? $row->is_deleted : '')); ?><?= bs_floating_input('created_by', 'text', (isset($row) ? $row->created_by : '')); ?><?= bs_floating_input('updated_by', 'text', (isset($row) ? $row->updated_by : '')); ?><?= bs_floating_input('deleted_by', 'text', (isset($row) ? $row->deleted_by : '')); ?><?= bs_floating_input('created_at', 'text', (isset($row) ? $row->created_at : '')); ?><?= bs_floating_input('updated_at', 'text', (isset($row) ? $row->updated_at : '')); ?><?= bs_floating_input('deleted_at', 'text', (isset($row) ? $row->deleted_at : '')); ?>
        <div class="mt-3">

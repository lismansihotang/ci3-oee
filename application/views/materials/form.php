<?= card_open(isset($row) 
    ? '<i class="icon cil-window"></i> Edit Materials' 
    : '<i class="icon cil-window"></i> Tambah Materials') ?>
...
<form method="post">
    ...
    <?= bs_floating_input('qty', 'text', isset($row) ? $row->qty : '') ?>
    <?= bs_floating_input('jenis', 'text', isset($row) ? $row->jenis : '') ?>
    <?= bs_floating_input('lokasi_1', 'text', isset($row) ? $row->lokasi_1 : '') ?>
    <?= bs_floating_input('lokasi_2', 'text', isset($row) ? $row->lokasi_2 : '') ?>
